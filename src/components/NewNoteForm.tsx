...
const NewNoteForm: React.FC<NewNoteFormProps> = ({ onAddNote }) => {
  ...
  const SelectedIcon = { CheckSquare, Lightbulb, FileText }[
    (selectedCategoryObj?.icon as 'CheckSquare' | 'Lightbulb' | 'FileText') || 'CheckSquare'
  ];
      ...
      <div className="bg-gray-800 rounded-lg p-4">
        ...
        <div className="flex items-center justify-between mt-3">
          <div className="relative">
            ...
            >
              <SelectedIcon size={16} className={selectedCategoryObj?.color} />
            ...
            {showCategoryDropdown && (
              <div className="absolute bottom-full left-0 mb-2 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 z-10">
                {categories.map((category) => {
                  const Icon = { CheckSquare, Lightbulb, FileText }[
                    category.icon as 'CheckSquare' | 'Lightbulb' | 'FileText'
                  ];
                  return (
                    <button
                      key={category.name}
